...
function MagneticButton({
    ...
    return (
        <button
            ref={$root}
            className={`magnetic-button cursor-pointer relative z-1 touch-none ${className}`}
        ...
        >
            ...
            <span
                ref={$hover}
                className="magnetic-button--hover inline-block absolute z-minus-1 top-0 left-0 h-full w-full"
            />
        </button>
    )
}
